...
paymentMethod = document.querySelector("#payment-type")
...
function validateForm(event) {
  ...
  function togglePaymentDetails(e) {
    ...
    const creditCardContainer = document.querySelector("#card-number");
    const paypalContainer = document.querySelector("#paypal-user");
    ...
    if(theForm.paymentType.value === "credit-card") {
        creditCardContainer.classList.remove("hide");
        creditCardContainer.required = true;
    } else if(theForm.paymentType.value === "paypal-user") {
        paypalContainer.classList.remove("hide");
        paypalContainer.requires = true;
    }
